...
function Checkout() {
  return (
    <div className="py-6 bg-lightGold">
      ...
      <div className="flex flex-wrap justify-center pt-10 gap-10 md:gap-36 items-center">
      ...
      <section className="flex flex-col md:flex-row justify-center gap-10 md:gap-20 py-20 items-center">
        <div className="flex flex-col justify-between items-center md:items-start text-center md:text-left">
          <h2 className="tracking-wider">
            Our handymen are extremely well-qualified <br />
            and have years of professional experience under their <br />
            belt. experience under their belt
          </h2>
          <div className="grid grid-cols-2 gap-4 mt-6 w-full md:w-auto">
          ...
          <button className="bg-yellow-500 text-white py-2 px-6 mt-4 rounded-full">
            View more
          </button>
        </div>
        <div className="flex justify-center">
          <img src={img1} alt="" className="h-64 md:h-96" />
        </div>
      </section>
    </div>
  );
